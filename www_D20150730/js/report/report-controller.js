 ...
 */
app.controller('reportController',function($scope,$state,$rootScope,communicateService,paramsService,reportService,toaster) {
...
//            "acctDate":paramsService.currentDateStr,
        ...
        communicateService.communicate(paramsService.targetService,paramsService.targetMethod,content).success(function(data){
            ...
            if(data && data.isSuccess==0){
                ...
                toaster.pop({type:"warning",title:"检索失败",body:"没有查到报表数据"});
            }else{
...
app.controller('reportSwwgBusinessDevelopDayController',function($scope){
