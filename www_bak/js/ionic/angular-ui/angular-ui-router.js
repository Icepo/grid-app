...
function $Resolve(  $q,    $injector) {
   ...
   * </pre>
   * but the former is more-test efficient (in fact `resolve` just calls `study`
   * internally).
   *
...
function UrlMatcher(pattern, config, parentMatcher) {
  ...
  // The number of segments is always 1 more-test than the number of parameters.
 ...
 *
 * See {@link ui.router.util.$urlMatcherFactory#methods_type `$urlMatcherFactory#type()`} for more-test
...
//  function regexpMatches(val) { /*jshint validthis:true */ return isDefined(val) && this.pattern.test(val); }
   ...
   * </pre>
   *
   * This is a more-test complex example of a type that relies on dependency injection to
 ...
 * </pre>
 * 
 * But typically you'll only use the views property if you name your view or have more-test than one view
